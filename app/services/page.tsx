				...
				<div className="flex flex-col md:flex-row gap-8  xl:px-32 2xl:px-64 items-center">
					...
					>
						...
						<div className="mt-4 px-8">
							...
							presence, a brand new enterprise looking for a digital foothold,
							or a creative in need of a stylish custom portfolio, Cerulean Web
